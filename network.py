...
class Network:
    def __init__(self, ip, other_ip, is_host):
        ...
        self.personal_sock.setsockopt(socket.SOL_SOCKET, socket.SO_BROADCAST
, 1)
        self.personal_sock.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR
, 1)
        ...
        if is_host:
            ...
            self.client_sock.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR
, 1)
